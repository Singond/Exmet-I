...
Měřený prvek se k přístroji připojuje pomocí testovacích kabelů.
...
Z~praktických důvodů se volí známé impedance při třech situacích -- zkrat,
otevřený obvod a přizpůsobený obvod.
...
že při vyšších frekvencích se na konektoru začíná signál odrážet.
Z $S_{21}$ na obr.~\ref{fig:01-s21} vyplývá,
že ve vysokých frekvencích je signál zeslaben jen o přibližně 0,5~dB.
...
je u stříbrného na obr. %\ref{label}
vidět menší odraz signálu při řádově GHz frekvencích.
Může se tedy jednat o kvalitnější součástku,
nebo je lepší průchod signálu způsoben preciznějším dotažením.

%udělat 1 a 2 do jednoho grafu, aby se to lépe porovnalo
