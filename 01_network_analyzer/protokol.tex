...
pro průchodku BNC\female jsou na obr.~\ref{fig:05-result-sparam}.
Opět vidíme, že pro frekvence nad $\SI{1}{\giga\hertz}$ nejsou
tyto konektory vhodné.
...
K~útlumům dochází při frekvencích $\SI{0.1}{\giga\hertz}$ a výše.
...
nárůst signálu. Tato frekvence odpovída vlnové délce $\wavelencrit = c/f =
