...
Při výpočtech sériově zapojených prvků je vhodné zavést transmisní matici $T$ pro každý z~prvků.
...
Dle \cite{rfhandbook} je konektor vhodný až do frekvence 11~GHz, většinou je však uváděna hodnota nižší.
