...
V porovnání s konektorem ve zlaté barvě z prvního měření je u stříbrného na obr. %\ref{label}
...
\subsection{7. měření}
Měříme (SMAf/BNCm)---(BNCf/BNCm + kabel/BNCf)---(BNCm/SMAf). Zapojení stejné jako u měření 6, tentokrát je však na prostřední vstup T členu připojen kabel neznámé délky. %Mění se fáze?
