...
\SI{1e4}{\hertz}$ je vypočítaná hodnota kapacity $\capacitance = 
\SI{1e-8}{\farad}$.
...
obr.~\ref{fig:exp15}. Úkolem je spočítat odpor rezistoru. 
...
\begin{figure}[htp]
	...
	\caption{Spočtené hodnoty kapacity $\impedance$ banánků s~vodičem.}
...
\begin{figure}[htp]
	...
	\caption{Spočtené hodnoty kapacity $\impedance$
