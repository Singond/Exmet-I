...
Ve vypočítaných hodnotách $\sparam_{11}$ a~$\sparam_{21}$ se objevují
výrazné píky, podle kterých dochází na redukci k~zesílení signálu,
což není fyzikálně možné.
I~přes ověření správnosti výpočtu jsme tuto chybu nedokázali odstranit.
